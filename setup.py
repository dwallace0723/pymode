...
__version__ = None
exec(open("pymode/version.py").read())
...
class ValidateCommand(BaseCommand):
    ...
    def run(self):
        ...
        self._run("Running black…", [sys.executable, "-m", "black", f"{here}/pymode"])
        self._run("Running flake8…", [sys.executable, "-m", "flake8", f"{here}/pymode"])
...
setup(
    name="pymode",
    version=__version__,
    description="Python SDK for the Mode v2 API.",
    keywords="modeanalytics",
